...
import { getSummary, computeReadiness } from '@/data/questionBank'
...
const learningModes = [
  {
    ...
    icon: Target,
    href: `/learn/${Math.max(...summaryData.meta.years)}`,
    recommended: true,
  },
  {
    id: 'sequential',
...
export function HomePage() {
  const { meta, playlists } = summaryData
      ...
      <section className="px-4 pt-10 pb-8 sm:pt-16 sm:pb-12">
        <div className="mx-auto max-w-2xl text-center">
          <div className="mb-4 flex items-center justify-center gap-2">
            <img
              src={import.meta.env.BASE_URL + 'images/jutor-logo.png'}
              alt="Jutor"
              width={32}
              height={32}
              className="rounded"
